SDI Knowledge Directory | Searching the Repository

Knowledge Directory Search query syntax
===================

When searching on SDI Knowledge Base with :doc:`server side search </server-side-search/index>`,
